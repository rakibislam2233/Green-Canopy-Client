...
//   const images =
//     productData?.productImages?.map((image: string) => ({
...
//                   __html:
//                     isMobileOrTablet && !showFullDescription
//                       ? `${productData?.productDescription.substring(0, 150)}`
...
//                 disabled={!inStock}
//                 className={`w-full md:w-fit px-5 rounded-lg text-white py-3 transition-all duration-300 flex bg-primary justify-center items-center gap-2`}
//               >
